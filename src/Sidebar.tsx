...
export default function Sidebar({ open, onClose }: SidebarProps) {
  return (
    ...
    >
      <nav
        className={`fixed left-0 top-0 h-full w-80 bg-white dark:bg-black shadow-2xl transform transition-transform duration-300 ${open ? 'translate-x-0' : '-translate-x-full'}`}
        style={{
      ...
      >
        <div className="p-6 flex justify-between items-center mx-7 my-4">
          ...
          <button onClick={onClose} aria-label="Fechar" className="px-6 py-4">
